...
namespace SharpMap.GML
{
    ...
    public static class GMLProviderWrapper
    {
        /// <summary>
        ...
        public static GisShapeList GetFeatures(string gml, LayerVector layer, out Extent extent)
        {
            var res = new GisShapeList();
            res.Name = layer.Name;
            ...
            for (int i = 0; i < provider.Features.Count; i++)
            {
                var shpOrig = provider.Features[i];
        ...
        public static GisShapeList GetFeatures(string gml, out Extent extent)
        {
            var res = new GisShapeList();
            res.Name = "";
