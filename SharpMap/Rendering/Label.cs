...
namespace SharpMap.Rendering
{
    ...
    public class LabelBox : IComparable<LabelBox>
    {
        ...
        public LabelBox(Envelope rectangle)
        {
    ...
    public class Label : IComparable<Label>, IComparer<Label>
    {
        ...
        private Font _Font;
        private NetTopologySuite.Geometries.Point _LabelPoint;
        ...
        public Label(string text, NetTopologySuite.Geometries.Point labelpoint, float rotation, int priority, LabelBox collisionbox,
                     LabelStyle style)
        {
            _Text = text;
        ...
        /// Label position
        /// </summary>
        public NetTopologySuite.Geometries.Point LabelPoint
        {
